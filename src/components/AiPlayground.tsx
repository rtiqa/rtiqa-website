...
import { Sparkles, Play, Copy, Check, Terminal, Cpu, Bot, Layers, ArrowRight } from 'lucide-react';
...
export const AiPlayground: React.FC = () => {
  ...
  const sampleResponsesAr = [
    `{
  "الموديول": "مساعد رتقاء الذكي للمعلمين",
  ...
  "خطةالدرس": {
    ...
    "الهيكل": [
      ...
      {"الزمن": "07-25د", "المرحلة": "الاستكشاف السقراطي", "النشاط": "أسئلة تشخيصية موجهة من مساعد المعلم المباشر"},
      {"الزمن": "25-38د", "المرحلة": "التطبيق المتمايز", "النشاط": "مجموعات متدرجة (دعم، قياسي، متقدم)"},
      {"الزمن": "38-45د", "المرحلة": "تذكرة الخروج والتقييم", "النشاط": "اختبار سريع من 3 أسئلة يتم تصحيحه آلياً"}
    ],
    "معيار_التقييم": "تم ربط معايير التقييم آلياً بسجل درجات رتقاء للمدارس."
  }
}`,
    `{
  "الموديول": "محرك رتقاء للتحليلات التنبئية",
  ...
  "تنبيه_النمط": {
    ...
    `{
  "الموديول": "المعلم السقراطي الذكي للطلاب",
  ...
  "الحوار": {
    ...
    `{
  "الموديول": "الملخص الأسبوعي لأولياء الأمور",
