...
var require_server = __commonJS({
  "dist/server.cjs"(exports, module) {
    ...
    var init_postgres = __esm({
      "src/db/postgres.ts"() {
        import_pg = __toESM2(__require("pg"), 1);
    ...
    var import_express12 = __toESM2(__require("express"), 1);
    var import_path = __toESM2(__require("path"), 1);
    var import_express11 = __toESM2(__require("express"), 1);
    ...
    function getAuthSecret() {
      ...
      if (!devRuntimeSecret) {
        devRuntimeSecret = import_crypto.default.randomBytes(32).toString("hex");
      }
    ...
    function generateToken(user) {
      ...
      const signature = import_crypto.default.createHmac("sha256", secret).update(payloadEncoded).digest("base64url");
    ...
    function decodeAndVerifyToken(token) {
      try {
        ...
        if (sigBufferA.length !== sigBufferB.length || !import_crypto.default.timingSafeEqual(sigBufferA, sigBufferB)) {
          return null;
        }
    ...
    var import_crypto2 = __toESM2(__require("crypto"), 1);
    var HASH_ITERATIONS = 1e4;
    var KEY_LENGTH = 64;
    var DIGEST = "sha512";
    function hashPassword(password) {
      const salt = import_crypto2.default.randomBytes(16).toString("hex");
      const derivedKey = import_crypto2.default.pbkdf2Sync(password, salt, HASH_ITERATIONS, KEY_LENGTH, DIGEST).toString("hex");
    ...
    function verifyPassword(password, storedHash) {
      try {
        ...
        return import_crypto2.default.timingSafeEqual(keyBuffer, derivedBuffer);
      } catch {
        return false;
      }
    }
    function generateInviteCode() {
      const segment1 = import_crypto2.default.randomBytes(2).toString("hex").toUpperCase();
      const segment2 = import_crypto2.default.randomBytes(2).toString("hex").toUpperCase();
    ...
    var import_express2 = __toESM2(__require("express"), 1);
    var academicRouter = import_express2.default.Router();
    ...
    var import_express3 = __toESM2(__require("express"), 1);
    var userRouter = import_express3.default.Router();
    ...
    var import_express4 = __toESM2(__require("express"), 1);
    var courseRouter = import_express4.default.Router();
    ...
    var import_express5 = __toESM2(__require("express"), 1);
    var lessonRouter = import_express5.default.Router();
    ...
    var import_express6 = __toESM2(__require("express"), 1);
    var assignmentRouter = import_express6.default.Router();
    ...
    var import_express7 = __toESM2(__require("express"), 1);
    var attendanceRouter = import_express7.default.Router();
    ...
    var import_express8 = __toESM2(__require("express"), 1);
    var gradebookRouter = import_express8.default.Router();
    ...
    var import_express9 = __toESM2(__require("express"), 1);
    var dashboardRouter = import_express9.default.Router();
    ...
    var import_express10 = __toESM2(__require("express"), 1);
...
${safety.sanitizedPrompt}`;
    ...
    var aiRouter = import_express10.default.Router();
...
${content}` : "\u064A\u0631\u062C\u0649 \u062A\u0644\u062E\u064A\u0635 \u0645\u062D\u062A\u0648\u0649 \u0647\u0630\u0627 \u0627\u0644\u062F\u0631\u0633 \u0627\u0644\u0645\u062D\u062F\u062F \u0628\u062F\u0642\u0629 \u0648\u0627\u0633\u062A\u062E\u0631\u0627\u062C \u0627\u0644\u0645\u0641\u0627\u0647\u064A\u0645 \u0627\u0644\u0623\u0633\u0627\u0633\u064A\u0629.";
    ...
    var platformApiRouter = import_express11.default.Router();
...
async function handler(req, res) {
  if (!cachedApp) {
    const createAppFn = import_server.default.createApp || import_server.default.default?.createApp;
